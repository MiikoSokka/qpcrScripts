...
getCqValues <- function(file.data){
  ...
  while (ncol.df > 1){
    ...
    if (df.sample[40,2] / df.sample[1,2] > 10){
...
# Main function to get manually generated Ct values from a file
...
list.options <- list( 
  make_option(c("-i", "--input"), type="character", 
              help="Input file name. Directly obtained from qPCR machine as a csv file.",
